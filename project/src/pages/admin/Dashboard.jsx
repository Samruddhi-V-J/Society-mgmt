  ...
  //               {stat.title}
  //             </Typography>
  //             <Typography variant="h3" sx={{ color: '#1B2B65', fontWeight: 'bold' }}>
  //               {stat.value}
  //             </Typography>
  //           </Paper>
  //         ))}
  ...
  //       {/* <Typography variant="h5" mb={2}>Resident Details</Typography> */}
  //       <Typography variant="h5" sx={{ mt: 4}}>Resident Details</Typography>
  ...
  //               <div className="resident-description">
  //                 <h3><strong>{resident.name}</strong></h3>
  //                 <p>Block - {resident.flatNo ? resident.flatNo.charAt(0).toUpperCase() : "N/A"} </p>
  //                 <p><MdHome className="icon" /> Flat No : {resident.flatNo || "N/A"} </p>
  //                 <p><PiBuildingApartmentFill className="icon" /> Society : {resident.societyName || "N/A"} </p>
  //                 <p><FaEnvelope className="icon" /> Postal Code : {resident.postal || "N/A"} </p>
  //               </div>
  //             </div>
  //         ))}
  //       </div>
